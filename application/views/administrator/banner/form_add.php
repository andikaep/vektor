        ...
        <div class="section-body">
            ...
            <div class="row">
                <div class="col-12 col-md-8 col-lg-8">
                    <div class="card">
                        <form class="needs-validation" novalidate="" method="POST" action="<?= base_url() ?>admin/web/banner/add" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="form-group">
                                    <label>Judul Banner</label>
                                    <input type="text" name="judul_banner" class="form-control" required="" placeholder="Masukkan nama website">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="keterangan_banner" class="form-control" required="" placeholder="Masukkan keterangan">
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    <label>Link</label>
                                    <input type="text" name="link_banner" class="form-control" required="" placeholder="Masukkan Link">
                                    <div class="invalid-feedback">
                                        Link tidak valid
                                    </div>
