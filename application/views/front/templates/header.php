...
<head>
	...
	<!-- Custom-Files -->
	<link rel="icon" href="<?=base_url()?>/assets/img/coy.jpg" type="image/gif">
	...
	<!-- Main css -->
	<link rel="stylesheet" href="<?= base_url('assets/front/') ?>css/fontawesome-all.css">
	<!-- Font-Awesome-Icons-CSS -->
	<link href="<?= base_url('assets/front/') ?>css/popuo-box.css" rel="stylesheet" type="text/css" media="all" />
	<!-- pop-up-box -->
	<link href="<?= base_url('assets/front/') ?>css/menu.css" rel="stylesheet" type="text/css" media="all" />
	<!-- menu style -->
	<!-- //Custom-Files -->
